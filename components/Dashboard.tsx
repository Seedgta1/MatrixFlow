        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
          ...
          {activeTab === 'network' && (
            <div className="space-y-6 animate-enter">
              ...
              {showAddUser && (
                <div className="glass-card p-6 rounded-2xl border border-white/5 animate-enter">
                  ...
                  <form onSubmit={handleAddUser} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" placeholder="Username" required value={newUsername} onChange={e => setNewUsername(e.target.value)} className="glass-input rounded-lg px-4 py-2 text-white" />
                    <input type="password" placeholder="Password" required value={newUserPass} onChange={e => setNewUserPass(e.target.value)} className="glass-input rounded-lg px-4 py-2 text-white" />
                    <input type="email" placeholder="Email" required value={newUserEmail} onChange={e => setNewUserEmail(e.target.value)} className="glass-input rounded-lg px-4 py-2 text-white" />
                    <input type="tel" placeholder="Telefono" required value={newUserPhone} onChange={e => setNewUserPhone(e.target.value)} className="glass-input rounded-lg px-4 py-2 text-white" />
              ...
              {/* Tree Visualization */}
              <div className="h-[400px] md:h-[600px] w-full glass-card rounded-2xl border border-white/5 overflow-hidden">
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-4">
                    <div className="flex-1 w-full">
                      ...
                      <div className="relative group">
                        ...
                        <div className="glass-input border-2 border-dashed border-slate-600 rounded-xl p-4 flex items-center justify-center gap-3 group-hover:border-indigo-500 transition-colors">
                    ...
                    <div className="flex-1 w-full space-y-3">
                      <form onSubmit={handleAddUtility}>
                        <div className="grid grid-cols-2 gap-3 mb-3">
                          <select value={utilType} onChange={(e) => setUtilType(e.target.value as UtilityType)} className="glass-input rounded-lg px-3 py-2 text-white">
                            <option value="Luce">Luce</option>
                            <option value="Gas">Gas</option>
                          </select>
                          <input type="text" placeholder="Fornitore (es. Enel)" value={utilProvider} onChange={e => setUtilProvider(e.target.value)} className="glass-input rounded-lg px-3 py-2 text-white" />
                        </div>
                  ...
                  currentUser.utilities.map(util => (
                    <div key={util.id} className="glass-card p-5 rounded-xl border border-white/5 flex items-center justify-between">
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <span className={`px-3 py-1 rounded-full text-xs font-bold border ${util.status === 'Attiva' ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-400' :
                      ...
                      <div className="flex gap-2">
                        <div className="relative flex-1">
                          ...
                          <input
                            ...
                            className={`w-full glass-input rounded-lg pl-10 pr-4 py-2.5 text-white focus:outline-none ${isEditingContact ? 'border-indigo-500' : 'border-slate-700 opacity-70'}`}
                          />
                        </div>
                      </div>
                    </div>
